...
{
    [Fact]
    public async Task Release_cli_reports_version_0_4_2_and_advertises_manager_mode()
    {
        ...
        Assert.Equal("0.4.2", AssemblyName.GetAssemblyName(assembly).Version!.ToString(3));
    ...
    [Fact]
    public async Task Release_publisher_rejects_an_invalid_version_with_0_4_2_guidance()
    {
        ...
        Assert.Contains("Version must look like 0.4.2", invalidVersion.Output);
    }
