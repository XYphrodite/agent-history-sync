...
{
    [Fact]
    public async Task Release_cli_reports_version_0_9_0_and_advertises_manager_mode()
    {
        ...
        Assert.Equal("0.9.0", AssemblyName.GetAssemblyName(assembly).Version!.ToString(3));
    ...
    public async Task Release_cli_answers_the_probe_that_gates_its_own_update()
    {
        ...
        Assert.Contains("agent-sync 0.9.0", version.Output);
    }
