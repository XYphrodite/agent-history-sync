...
{
    [Fact]
    public async Task Release_cli_reports_version_0_6_1_and_advertises_manager_mode()
    {
        ...
        Assert.Equal("0.6.1", AssemblyName.GetAssemblyName(assembly).Version!.ToString(3));
